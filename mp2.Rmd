...
ggplot(data = cand_spending, aes(x = cand_id, y = transaction_sum, col = new_ge_winner)) +
  ...
  ggtitle("Title") +
  labs(x = "Candidate", y = "Transaction Sum (million dollars)", col = "Loss or Win") +
...
ggplot(mutable_data, aes(x = org_type, y = transaction_amt, fill = cmte_dsgn)) +
  ...
  theme(legend.position = "top",
        axis.text.x = element_text(size = rel(0.9), angle = 10, hjust = 1)) +
  scale_x_discrete(name = "Interest Group Category",
                   labels = c("C" = "Corp.", "L" = "Labor Org.", "M" = "Membership Org.", "T" = "Trade Assn.", "V" = "Cooperative", "W" = "Corp. w/o capital stock"))
