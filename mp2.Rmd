...
For our third graph, we wanted to examine if there is a trend with the categorization (entity types) of the highest campaign donors during this election cycle. 
...
plot_3 +
  ...
  labs(x = "Entity Type", y = "Net Amount of Donations by Entities (millions of dollars)") +
