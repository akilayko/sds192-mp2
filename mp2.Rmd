...
>>>>>>> 8a7b3821bd8934c337e0411c7e8baae867eebe5d
}

entity_picker(entity = "PAC") +
  scale_y_continuous(breaks = c(0e+00, 0.5e+06, 1e+06, 1.5e+06, 2e+06, 2.5e+06, 3e+06, 3.5e+06, 4e+06, 4.5e+06),
                     labels = c("0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "4.5"))
entity_picker(entity = "ORG")
entity_picker(entity = "PTY") +
  labs(y = "Total Contributions (thousands of dollars)") +
